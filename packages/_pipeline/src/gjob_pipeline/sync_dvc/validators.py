...
import gjob_pipeline
from gjob_pipeline import sync_dvc
from gjob_pipeline.sync_dvc.contexts import DVC
from gjob_pipeline.sync_dvc.dvc import OutFlags, Stage
from gjob_pipeline.sync_dvc.types import DvcValidationInfo, Model
...
def dvc_prepare_stage(
    ...
    dvc.stage.cmd = sep.join([
        f"./Invoke-Uv {gjob_pipeline.__name__.replace('_', '-')}",
