...
from gjob_pipeline.models.contexts import ROOTED
...
from gjob_pipeline.sync_dvc.validators import (
    dvc_add_param,
    dvc_prepare_stage,
    dvc_set_stage_path,
)
...
class Stage(GjobPipelineContextStore):
    """Base of pipeline stage models."""

    model_config = get_gjob_pipeline_config(ROOTED, kinds_from=paths)
...
class StagePaths(GjobPipelineContextStore):
